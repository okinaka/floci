...
class SesServiceSuppressionReasonTest {
    ...
    void notOnList_returnsNull() {
        ...
        assertNull(service.resolveSuppressionReason("unknown@example.com", REGION));
    }
    ...
    void onListAndReasonInAccountSettings_returnsReason() {
        ...
        assertEquals("BOUNCE", service.resolveSuppressionReason("bouncer@example.com", REGION));
    }
    ...
    void onListButReasonNotInAccountSettings_returnsNull() {
        ...
        assertNull(service.resolveSuppressionReason("complainer@example.com", REGION));
    }
    ...
    void accountSettingsEmpty_returnsNull() {
        ...
        assertNull(service.resolveSuppressionReason("bouncer@example.com", REGION));
    }
    ...
    void leadingTrailingWhitespaceIsNormalized() {
        ...
        assertEquals("BOUNCE",
                service.resolveSuppressionReason("  trim-me@example.com  ", REGION));
    }

    @Test
    void nullOrBlankInput_returnsNull() {
        assertNull(service.resolveSuppressionReason(null, REGION));
        assertNull(service.resolveSuppressionReason("", REGION));
        assertNull(service.resolveSuppressionReason("   ", REGION));
    }
}
